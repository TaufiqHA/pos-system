...
@section('content')
    <div class="flex flex-col sm:flex-row justify-end gap-3 mb-6 z-10">
        <button
            class="w-full sm:w-auto flex items-center justify-center px-5 py-2 rounded-full border border-green-400 text-green-400 font-bold text-xs tracking-wider hover:bg-green-400 hover:text-black transition">
            PO KE PUSAT
        </button>
        <button
