...
@section('title', 'Laporan Keuangan Cabang - POS')

@section('page_title', 'LAPORAN KEUANGAN CABANG')
@section('page_subtitle', 'Analisis profit, omset, dan penjualan barang ke outlet')
    ...
    <div class="card p-6 rounded-2xl border-gray-700 z-10 shadow-lg shadow-black/15 mb-8">
        <div class="flex justify-between items-center mb-6">
            <div class="flex items-center space-x-3">
                ...
                <h3 class="font-bold text-sm tracking-wide font-display text-white">GRAFIK PENJUALAN KE OUTLET</h3>
            </div>
        </div>
        <!-- CANVAS FOR CHART.JS -->
